    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 class="mb-0">Register Now!</h2>
              <p>Register Now to explore our Platform</p>
            </div>
          </div>
        </div>
      </div> 
                ...
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="password" id="pword" class="form-control form-control-lg" placeholder="Enter Password">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword2">Re-type Password</label>
                            <input type="password" id="pword2" class="form-control form-control-lg" placeholder="ReType Password">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">

...
<head>
  <title>Shri Ram Pratap Inter College </title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="d-flex align-items-center">
          ...
          <div class="mr-auto text-right" style="float: right;">
            <nav class="site-navigation position-relative col-xs-10 text-right" role="navigation"  style="float: right;">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                  <a href="admissions.php" class="nav-link text-left">Teachers</a>
                </li>
                <li>
